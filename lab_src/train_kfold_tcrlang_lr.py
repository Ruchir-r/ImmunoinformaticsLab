...
from nettcr_torch.model_tcrlang_norm import CNN_CDR123_global_max_normalization
from nettcr_torch.train_lr import train_one_fold
...
def main():
    ...
    model = CNN_CDR123_global_max_normalization(
        embed_dim=480,
        filters=16,
